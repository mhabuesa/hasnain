            ...
            <div class="row g-4">
                <div class="col-lg-12 rounded">
                    <div class="slider-animate">
                        <div>
                            <div class="home-contain p-0">
                                <img src="{{ asset($main_banner->image) }}"
                                    class="img-fluid bg-img blur-up lazyload" alt="">
                                <div class="home-detail home-big-space p-center-left home-overlay position-relative">
                                    <div class="container-fluid-lg">
                                        <div>
                                            <h6 class="ls-expanded theme-color text-uppercase">{{$main_banner->subtitle}}</h6>
                                            <h2 class="content-2">{{$main_banner->title}}</h2>
                                            <h5 class="text-content">{{$main_banner->short_title}}</h5>
                                            <button
                                                class="btn theme-bg-color btn-md text-white fw-bold mt-md-4 mt-2 mend-auto"
                                                onclick="location.href = '{{route('product.details', $main_banner->product->slug)}}';">Shop Now <i
                ...
                <div>
                    <div class=" banner-contain-3 hover-effect">
                        <a href="javascript:void(0)">
                            <img src="{{ asset($banner->image) }}" class="bg-img blur-up lazyload" alt="">
                        </a>
                        <div class="banner-detail p-center-left w-75 banner-p-sm mend-auto">
                            <div>
                                ...
                                <p class="fw-light mb-2">{{ $banner->short_title }}</p>
                                <button onclick="location.href = '{{route('product.details', $banner->product->slug)}}';"

                    ...
                    <div class="row g-4">
                                                ...
                                                <div>
                                                    <div class="slider-image">
                                                        <img src="{{ asset($gallery->image) }}" id="img-1"
                                                            data-zoom-image="{{ asset($gallery->image) }}"
                                                            class="img-fluid image_zoom_cls-0 blur-up lazyload m-auto"
                                                            alt="">
                                                    </div>
                                                </div>
                                            @endforeach
                        ...
                        <div class="col-xl-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="right-box-contain">
                                @if ($product->discount)
                                    <h6 class="offer-top">{{ number_format($product->discount) }}% Off</h6>
                                @endif
                                <h2 class="name">{{ $product->name }}</h2>
                                <div class="price-rating">
                                    <h3 class="theme-color price">&#2547; {{ number_format($product->current_price) }}
                                        @if ($product->regular_price)
                                            <del class="text-content">&#2547;
                                                {{ number_format($product->regular_price) }}</del>
                                        @endif
                                        @if ($product->discount)
                                        <span class="offer theme-color">({{ number_format($product->discount) }}%
                                            Off)</span>
                                        @endif
                                    </h3>
                                    ...
                                    <div class="tab-pane fade show active" id="description" role="tabpanel"
                                        ...
                                        <div class="product-description">
                                            ...
                                            <div class="banner-contain nav-desh">
                                                <img src="{{ asset('frontend') }}/images/vegetable/banner/14.jpg"
                                                        ...
                                                        <ul class="review-list">
                                                                ...
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image">
                                                                            <img src="{{ asset('frontend') }}/images/review/1.jpg"
                                                            ...
                                                            <li>
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image">
                                                                            <img src="{{ asset('frontend') }}/images/review/2.jpg"
                                                                                class="img-fluid blur-up lazyload"
                                                                                alt="">
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <li>
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image">
                                                                            <img src="{{ asset('frontend') }}/images/review/3.jpg"
                                                                                class="img-fluid blur-up lazyload"
                                                                                alt="">
                                                                        </div>
                                                                    </div>
                    ...
                    <div class="right-sidebar-box">
                        <div class="vendor-box">
                            <div class="verndor-contain">
                                <div class="vendor-image">
                                    <img src="{{ asset('frontend') }}/images/product/vendor.png" class="blur-up lazyload"
                                        alt="">
                                </div>
                        ...
                        <div class="ratio_156 pt-25">
                            <div class="home-contain">
                                <img src="{{ asset('frontend') }}/images/vegetable/banner/8.jpg"
                                    class="bg-img blur-up lazyload" alt="">
                                ...
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-2.html">
                                            <img src="{{ asset('frontend') }}/images/cake/product/11.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
